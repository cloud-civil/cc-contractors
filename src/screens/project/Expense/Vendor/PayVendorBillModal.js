...
const FormComponent = props => {
  const {setShowModal, project_id, activeItem, reRender, setRender} = props;
  const {payment_id, amount, bill_id, images} = activeItem;
  ...
  const payBill = () => {
    axiosInstance(token)
      .post('/expense/vendor/payMaterialVendorBill', {
        payment_id,
        amount,
        bill_id,
...
export const PayVendorBillModal = props => {
